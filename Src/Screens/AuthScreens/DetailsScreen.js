    ...
    return (
      <SafeAreaView style={styles.container}>
        <ImageBackground source={images.Splash} style={styles.image}>
          ...
          <Text style={{fontSize:16,textAlign:'center', marginTop:80,color:'white'}}>LOG IN</Text>
        ...
        <Text style={{color:'#fff',alignSelf:'flex-end',marginRight:30,}}>Forgot password?</Text>
